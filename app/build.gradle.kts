...
android {
  ...
  defaultConfig {
    applicationId = "com.aistudio.savelock.rvyqpk"
    minSdk = 30
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
  ...
  buildTypes {
    ...
    debug {
      // Use AGP's auto-generated debug keystore so CI and any machine can build without a
      // committed debug.keystore (which is git-ignored for safety).
    }
  }
  compileOptions {
